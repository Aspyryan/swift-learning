...
struct PaletteChooser: View {
    ...
    func body(for palette: Palette) -> some View {
        ...
        .popover(item: $paletteToEdit) { palette in
            PaletteEditor(palette: $store.palettes[palette], emojiFont: emojiFont)
                .wrappedInNavigationWithToMakeDismissable { paletteToEdit = nil }
        }
...
struct PaletteChooser_Previews: PreviewProvider {
    static var previews: some View {
        PaletteChooser()
            .environmentObject(PaletteStore(named: "Testing"))
    }
}
